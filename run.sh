...
# Detect vehicles
python3.6 vehicle-detection.py $input_dir $output_dir

# Detect license plates
python3.6 license-plate-detection.py $output_dir $lp_model

# OCR
python3.6 license-plate-ocr.py $output_dir

# Draw output and generate list
python3.6 gen-outputs.py $input_dir $output_dir > $csv_file
